...
-- TAULA ULLERA
INSERT INTO ULLERA (graduacio_izq, graduacio_der, muntura, color_muntura, color_vidre,  preu, id_marca)
VALUES 
('0.50', '0.50', 'flotant', 'negre', 'transparent', 150.00,2),
('1.00', '1.00', 'pasta', 'blanc', 'gris',  200.00, 1),
('-0.75', '-0.75', 'metalica', 'plata', 'marró',  180.00, 4),
('-1.25', '-1.25', 'flotant', 'blau', 'verd',  220.00, 5),
('-2.00', '-2.00', 'pasta', 'marró', 'marró',  250.00, 2),
('0.75', '0.75', 'metalica', 'negre', 'transparent',  190.00, 3),
('-1.50', '-1.50', 'flotant', 'rosa', 'transparent',  230.00, 6),
('-2.25', '-2.25', 'pasta', 'negre', 'negre',  270.00, 7),
('-0.50', '-0.50', 'metalica', 'plata', 'transparent',  200.00, 7),
('1.50', '1.50', 'flotant', 'gris', 'vermell',  240.00,  3),
('-1.75', '-1.75', 'flotant', 'platejat', 'blau',  260.00, 2),
('-0.25', '-0.25', 'pasta', 'verd', 'verd', 70, 4),
('-1.00', '-1.00', 'metalica', 'negre', 'gris', 120, 5),
('0.25', '0.25', 'flotant', 'blanc', 'transparent',  200.00,1),
('-2.50', '-2.50', 'pasta', 'marró', 'marró',  270.00,  6),
('-1.00', '-1.00', 'metalica', 'plata', 'blau',  240.00,  3),
('0.50', '0.50', 'flotant', 'negre', 'negre', 220.00, 2),
('-2.00', '-2.00', 'pasta', 'gris', 'gris',  260.00,  1),
('-0.75', '-0.75', 'metalica', 'plata', 'transparent', 200.00,  4),
('-1.50', '-1.50', 'flotant', 'negre', 'negre',  230.00, 5),
('1.25', '1.25', 'metalica', 'plata', 'marró',  180.00, 3),
('-1.25', '-1.25', 'flotant', 'blau', 'verd',  220.00, 1),
('-2.00', '-2.00', 'pasta', 'marró', 'marró',  250.00,  2),
('0.75', '0.75', 'metalica', 'negre', 'transparent',  190.00, 3),
('-1.50', '-1.50', 'flotant', 'rosa', 'transparent',  230.00, 1);

-- TAULA VENDA
INSERT INTO `VENDA` (`data`, `id_client`, `id_empleat`,`id_ullera`) VALUES 
('2021-05-10 08:30:00', 1, 3,2),
('2021-09-20 14:45:00', 2, 1,4),
('2022-02-15 10:00:00', 3, 1,6),
('2022-06-30 16:20:00', 4, 1,8),
('2023-01-05 09:15:00', 5, 3,7),
('2023-07-12 11:30:00', 6, 2,9),
('2021-03-18 11:00:00',7,2,10),
('2022-08-25 15:40:00',8,3,12),
('2022-11-10 09:55:00',9,1,13),
('2023-04-30 12:20:00',11, 3,15),
('2023-10-15 17:00:00',1,1,14),
('2021-07-05 13:15:00',1,2,3),
('2022-01-20 10:30:00',1,1,16),
('2022-09-12 14:00:00',2,3,18),
('2023-03-08 16:45:00',1,2,20);
